...
2) Очень активно принимал участие во многих активностях: участвовал на соревнованиях по легкой атлетике, армейскому рукопашному бою и т.д.
...
Также я продолжаю изучать JS, на данный момент прохожу книжный курс Node.js:разработка микросервисной архитектуры а дальше начну изучать Next.js.

<h2>Моё образование: </h2>

1) Образование: Средне-специальное, факультет: «Механизация сельского хозяйства», срок обучения: 3 года и 10 месяцев, квалификация: техник-механик:

2) Мидл фронтенд-разработчик от Яндекс практикума;
